...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, websockets, score_coefficients, args):
    ...
    factorgrad = FactorGradController(
        enabled=args.factorgrad_enable,
        topology_end_iteration=opt.densify_until_iter,
        stabilization_steps=args.factorgrad_stabilization_steps,
        frozen_probability=args.factorgrad_probability,
        seed=args.factorgrad_seed,
        schedule=args.factorgrad_schedule,
        early_start_iteration=args.factorgrad_early_start_iteration,
    )
    ...
    print(f"Time taken by {os.getenv('OAR_JOB_ID')}: {training_time}s")
        ...
        json.dump(
            {
                ...
                "factorgrad_enabled": bool(args.factorgrad_enable),
                "factorgrad_schedule": args.factorgrad_schedule,
                "host": "Taming-3DGS",
            },
            handle,
            indent=2,

...
class FactorGradParams(ParamGroup):
    factorgrad_enable = False
    factorgrad_schedule = "full"
    factorgrad_early_start_iteration = 3000
    factorgrad_stabilization_steps = 768
    factorgrad_probability = 2.0 / 3.0
    factorgrad_seed = 3407
    factorgrad_no_importance_correction = False
    factorgrad_log_interval = 10

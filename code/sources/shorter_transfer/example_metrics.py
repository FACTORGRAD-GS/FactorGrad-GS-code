...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_test_only",
        action="store_true",
        help="When saving images, retain only the held-out test views",
    )
    ...
    for loader_name,loader in loaders.items():
        ...
        save_loader_images = args.save_images and (
            not args.save_test_only or loader_name == "Testset"
        )
        if save_loader_images:
